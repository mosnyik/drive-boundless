      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground text-lg">
            Browse affordable car rentals available near Lawrenceville and metro
            Atlanta. Each vehicle is maintained for clean, comfortable, and
            reliable everyday travel.
          </p>
        </div>
              ...
              >
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 text-sm border-t border-border pt-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {vehicle.minRentalDays} day
                        {vehicle.minRentalDays > 1 ? "s" : ""}
                      </span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="flex items-end justify-between mt-6 pt-4 border-t border-border">
                    ...
                    <div>
                      <p className="font-serif text-xl font-medium">${vehicle.pricePerWeek}</p>
